...
Installing "Justg Addons" can be done either by searching for "Justg Addons" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
